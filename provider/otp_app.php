...
/**
 * RFC 6238 compliant one time pad autenticator app
 */
class otp_app extends base_provider {
    ...
    public function display_setup_form($user_id)
    {
        ...
        $html .=        get_string('providersetupformmessage_otp_app', 'local_twofactorauth');
        $html .= '    </label>';
